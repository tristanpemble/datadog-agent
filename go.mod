...
require (
	...
	go.opentelemetry.io/collector/service v0.130.1
...
require (
	...
	go.opentelemetry.io/collector/exporter/nopexporter v0.130.1 // indirect
	...
	go.opentelemetry.io/collector/receiver/nopreceiver v0.130.1 // indirect
